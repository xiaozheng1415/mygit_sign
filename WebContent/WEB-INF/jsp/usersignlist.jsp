...
<script type="text/javascript">
	function skipPage(){
		...
		window.location="${ctx}/user/findAllsignByuser.do?pageNo="+pageNo;
...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div>
        <ul class="nav navbar-nav">
            <li><a href="${ctx }/user/getusers.do">用户管理</a></li>
            <li class="active"><a href="${ctx }/user/findAllsignByuser.do">签到记录</a></li>
...
<!-- /.container-fluid --> 
	...
	<div class="row">
		<div class="col-md-6" style="text-align:right;">
			...
			<li><a href="${ctx }/user/findAllsignByuser.do?pageNo=${page.pageNo-1 }">&laquo;</a></li>
			</c:if>
			
			<c:forEach var="i" items="${page.slider }">
				<li><a href="${ctx }/user/findAllsignByuser.do?pageNo=${i }">${i }</a></li>
			</c:forEach>	
			
			<c:if test="${!page.lastPage }">
				<li><a href="${ctx }/user/findAllsignByuser.do?pageNo=${page.pageNo+1 }">&raquo;</a></li>
			</c:if>
		  </ul>
			</p>	
